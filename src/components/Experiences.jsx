            ...
            <TimelineItem>
                ...
                <TimelineContent sx={{fontFamily: "Poppins",}}>
                    <div className='py-10 mr-80 bg-slate-100 opacity-85 rounded-3xl border-slate-300 border-2 border-solid border-opacity-50'>
                        ...
                        <p className='py-3 px-10 font-medium text-md leading-normal'>The South Asian Heart Foundation is a nonprofit organization I started to help spread awareness and raise funds for Heart Disease in South Asian people.</p>
